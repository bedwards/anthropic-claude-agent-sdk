"""
Git operations for worker agents.
...
from .base_models import LogLevel
...
class GitOperations:
    ...
    def __init__(
        ...
        self.branch = f"{branch_prefix}/issue-{issue_number}"
    ...
    async def initialize_worktree(self) -> None:
        ...
        if pyproject.exists():
            self.status_manager.log(
                LogLevel.INFO, "Installing Python dependencies in worktree..."
            )
